...
4. ## 本日・今夜の注目ニュース（web検索で本日〜明日の経済指標・イベント予定を確認し、2〜4件を「一般的に意識されやすい影響」の解説付きで。各見出しに【重要度：高/中/低】を付け、重要度の高い順に並べる）`);
  } else {
...
2. ## 日経平均の値動き（表＋解説）
3. ## ドル円・金の動き（短い解説）
4. ## 今晩〜明日の注目ニュース（web検索で今晩の米国の経済指標・イベントや明日の国内予定を確認し、2〜4件を「一般的に意識されやすい影響」の解説付きで。各見出しに【重要度：高/中/低】を付け、重要度の高い順に並べる）`);
  }
